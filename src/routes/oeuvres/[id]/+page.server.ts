...
export const load = (async ({ locals, url, params }) => {
  ...
  const lignes = await cachedEntries<TypeLigneSkeleton>({ content_type: "ligne", include: 2, "links_to_entry": oeuvre.sys.id, limit: 1, locale: { 'en': 'en-CA' }[languageTag()] || 'fr-CA' })
