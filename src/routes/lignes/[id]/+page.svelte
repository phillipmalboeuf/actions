...
<section class="flex flex--thick_gapped {data.format || "gallerie"}" class:ready class:first={active === 0}>
  ...
  <nav class="col selector" aria-label={languageTag() === "en" ? "Select an exhibition" : "Sélectionner une exposition"}>
  ...
  <nav class="col col--mobile--12of12 formats" aria-label={languageTag() === "en" ? "Select an exhibition" : "Sélectionner une exposition"} style:--current-color={data.ligne.fields.couleur}>
